...
//Move changes
	...
	lunarblessing: {
		...
		category: "Status",
		name: "Lunar Blessing",
		desc: "Recovers 50% max HP and cures status.",
		shortDesc: "Recovers 50% max HP and cures status.",
		pp: 10,
		priority: 0,
		flags: {snatch: 1, heal: 1},
		heal: [1, 2],
	...
	victorydance: {
		...
		category: "Status",
		name: "Victory Dance",
		desc: "Increase Atk, Def, and Spe by +1 stage.",
		shortDesc: "Increase Atk, Def, and Spe by +1 stage.",
		pp: 20,
		priority: 0,
	...
	esperwing: {
		num: 38,
		desc: "High crit ratio and priority.",
		shortDesc: "High crit ratio and priority.",
		accuracy: 90,
		basePower: 75,
		category: "Special",
		critratio: 3,
	...
	psyshieldbash: {
		...
		desc: "100% chance to increase Def and SpD by 1 stage.",
		shortDesc: "100% chance to increase Def and SpD by 1.",
		self: {
			boosts: {
				def: +1,
				spd: +1,
	...
	stoneaxe: {
		...
		category: "Physical",
		name: "Stone Axe",
		desc: "Traps and damages opponent over time, has a high crit ratio.",
		shortDesc: "Traps and damages opponent over time, has a high crit ratio.",
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1},
	...
	infernalparade: {
		...
		desc: "Hex with a 30% burn chance.",
		shortDesc: "Hex with a 30% burn chance.",
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1},
		secondary: {
	...
	barbbarrage: {
		...
		category: "Special",
		name: "Barb Barrage",
		desc: "Hex with a 30% poison chance.",
		shortDesc: "Hex with a 30% poison chance.",
		pp: 15,
		priority: 0,
		flags: {protect: 1, mirror: 1},
		secondary: {
	...
	triplearrows: {
		desc: "Hits three times with a high crit ratio.",
		shortDesc: "Hits three times with a high crit ratio.",
		num: 140,
		accuracy: 100,
		basePower: 30,
		category: "Physical",
