export const Pokedex: {[k: string]: ModdedSpeciesData} = {
     ...
     palossand: {
		inherit: true,
		baseStats: {hp: 96, atk: 100, def: 135, spa: 100, spd: 85, spe: 20},
	...
	centiskorch: {	
		inherit: true,
            baseStats: {hp: 125, atk: 125, def: 85, spa: 75, spd: 85, spe: 65},	
	...
	emboar: {	
		inherit: true,	
		baseStats: {hp: 119, atk: 133, def: 115, spa: 52, spd: 85, spe: 35},	
	...
	seaking: {	
		inherit: true,	
		baseStats: {hp: 80, atk: 130, def: 65, spa: 105, spd: 80, spe: 78},	
	},	
	basculin: {	
		inherit: true,	
